...
$NOMBRE_SHOW = "Centro Web";
$NOMBRE_SHOW_PLURAL = "Centros Web";
            ...
            <div id="table_report_wrapper" class="dataTables_wrapper" role="grid">
                <table id="table_report" class="table table-striped table-bordered table-hover dataTable"
                    ...
                    <tr role="row">
						...
						<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1"
                            colspan="1"
                            style="width: 143px;">Denominación
                        </th>						
                    ...
                    if(!empty($data) && $data != false){
                        ...
                        foreach($data as $d){
                            ...
                            echo "<td class=\"nombre\">".$d['kostl']."</td>";
							echo "<td class=\"cod_sap\"><small>".$d['ktext']."</small></td>";							
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="validation-form_nuevo" method="get" novalidate="novalidate">
                        <div class="control-group">
                            <label class="control-label" for="nombre_nuevo">Centro de Costo :</label>
						...
						<div class="control-group">
                            <label class="control-label" for="cod_sap_nuevo">Denominación :</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="validation-form_editar" method="get" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="nombre_editar">Centro de Costo :</label>
						...
						<div class="control-group">
                            <label class="control-label" for="cod_sap_editar">Denominación :</label>

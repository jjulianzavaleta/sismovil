...
<script>
    $( '#listar_contract_approve_logistica' ).addClass( "active" );
...
<script type="text/javascript">
    $(function () {
        $('#table_report').dataTable({
            ...
            "searching": true,
            "ajax": {
                "url": "/phps/dContractLoadLogistica.php",
                "data": function ( d ) {
    ...
    function edit_go(id){
        location.href = "../contract_miscontratos/create.php?id="+id+"&mode=approve&role=logistica";
    }

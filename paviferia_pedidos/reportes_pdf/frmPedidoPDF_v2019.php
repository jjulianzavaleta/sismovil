...
// Pie de página
	...
	$this->Ln(8);
	$this->Image('../../assets/images/arte.png',0,null,0);
    } 
}
...
if($grupoProductosCot == 1){//Pavo
	...
	$pdf->MultiCell(180,$cell_height, 'Gracias por contactarte con Chimú Agropecuaria, 71 años de experiencia con nuestro producto "PAVO SAN FERNANDO" nos permite asegurarte la mejor cena navideña.' );
    $pdf->Ln(2);
...
if($grupoProductosCot == 2){//Paneton
    ...
    $pdf->Ln(2);
    $pdf->MultiCell(180,$cell_height, 'A continuación, presentamos la cotización para la presente CAMPAÑA NAVIDEÑA 2018:' );
}
...
$pdf->Cell(180,$cell_height,'Precio válido:          Hasta el '.date_to_text($fechafinValides),0,1,'L');
$pdf->Cell(180,$cell_height,'Forma de pago:       '.$modopago,0,1,'L');
$pdf->Cell(180,$cell_height,'Vigencia de Vales:  31 de Julio 2020',0,1,'L');

if($grupoProductosCot == 1) {//Pavo
    $pdf->SetFont('Times','',8);
    $pdf->Cell(180,$cell_height,'Lugar de Canje:      Prolongación Av Fátima s/n Sector Encalada  (Costado C.C. Real Plaza - Promart)',0,1,'L');
}
...
$pdf->Ln(2);
$pdf->SetFont('Times','',8);
$pdf->MultiCell(180,$cell_height, 'Para mayor información, te puedes comuniar con '.$user_name.' a los telefonos '.$user_telefonos.' y al correo electrónico '.$user_correo);
$pdf->Ln(2);
$pdf->SetFont('Times','',8);
$pdf->MultiCell(180,$cell_height, 'Agradecemos su atención y nos despedimos seguros de ofrecer el mejor servicio de venta y despacho de producto que como clientes y colaboradores merecen. ' );

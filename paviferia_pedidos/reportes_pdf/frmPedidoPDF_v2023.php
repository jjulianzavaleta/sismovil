...
if($grupoProductosCot == 1){//Pavo
	$pdf->MultiCell(180,$cell_height, 'Gracias por contactarte con Chimú Agropecuaria, 75 años de experiencia con nuestro producto "PAVO SAN FERNANDO" nos permite asegurarte la mejor cena navideña.' );
    $pdf->Ln(2);
...
if($grupoProductosCot == 1){//Pavo
    $pdf->Ln(2);
    $pdf->SetFont('Times','B',8);
    $pdf->MultiCell(180,$cell_height, 'PAVO ENTERO CONGELADO, marinado, c/menudencia, empacado al vacío, el mismo que es beneficiado con la más alta tecnología de exportación e higiene bajo normas ISO 9001, 14001, 22000, HACCP y BPM. (Certificaciones internacionales que garantizan la calidad, INOCUIDAD y cuidado del medio ambiente).');
}

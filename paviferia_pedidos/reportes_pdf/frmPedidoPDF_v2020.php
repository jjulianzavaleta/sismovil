...
$pdf->Ln(2);
$pdf->SetFont('Times','',8);
$pdf->MultiCell(180,$cell_height, 'Para mayor información, te puedes comunicar con '.$user_name.' a los telefonos '.$user_telefonos.' y al correo electrónico '.$user_correo);
$pdf->Ln(2);
$pdf->SetFont('Times','',8);

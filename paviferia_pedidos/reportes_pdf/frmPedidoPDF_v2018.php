...
if($grupoProductosCot == 1) {//Pavo
    $pdf->SetFont('Times','',8);
    $pdf->Cell(180,$cell_height,'•	Lugar de Canje: '.utf8_decode($zona_entregapav).' (Av Prolong. Fátima s/n - Sector Encalada) costado C.C. Real Plaza',0,1,'L');
}
...
$pdf->Ln(2);
$pdf->SetFont('Times','',8);
$pdf->MultiCell(180,$cell_height, '•	Para mayor información, comunicarse con '.$user_name.' a los telefonos '.$user_telefonos.' o escribir al e-mail '.$user_correo);
$pdf->Ln(2);
$pdf->SetFont('Times','',8);

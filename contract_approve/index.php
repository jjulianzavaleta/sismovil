...
<div id="page-content" class="clearfix">
    <div class="row-fluid">
        ...
        <div class="row-fluid">
            <a data-toggle="modal" href="#" onclick="go_derivados_a_mi()" class="btn btn-app btn-danger btn-mini" alt="Contratos derivados a mi usuario" title="Contratos derivados a mi usuario">
                <i class="icon-random"></i>
            </a>
            <a data-toggle="modal" href="#" onclick="go_derivados_por_mi()" class="btn btn-app btn-primary btn-mini" alt="Contratos derivados por mi usuario" title="Contratos derivados por mi usuario">
                <i class="icon-random"></i>
            </a>
            ...
            <div id="table_report_wrapper" class="dataTables_wrapper" role="grid">
                <table id="table_report" class="table table-striped table-bordered table-hover dataTable"
                    ...
                    <tr role="row">
						...
						<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1"
                            colspan="1"
                            style="width: 100px;">Aprob. Preliminar
                        </th>
						<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1"
                            colspan="1"
                            style="width: 100px;">Aprob. Final
                        </th>
						<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1"
                            colspan="1"
...
<script type="text/javascript">
    ...
    $('document').ready(function(){
        $('#table_report').DataTable({
            ...
            "searching": true,
            "ajax": {
                "url": "/phps/dContractLoadLegal.php"
            },
            "aoColumns": [
    ...
    function go_derivados_a_mi(){
        location.href = "../contract_approve/derivados_per_user.php?method=to";
    }

    function go_derivados_por_mi(){
        location.href = "../contract_approve/derivados_per_user.php?method=from";
    }

	function edit_go(id){
        location.href = "../contract_miscontratos/create.php?id="+id+"&mode=approve&role=legal";
    }
    ...
    function derivar_go(idcontrato){

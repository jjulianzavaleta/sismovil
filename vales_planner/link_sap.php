...
<div id="page-content" class="clearfix">
    <div class="row-fluid">
        <div class="row-fluid">
		<form class="form-horizontal" id="validation-form_nuevo" method="post" novalidate="novalidate" autocomplete="off" enctype="multipart/form-data" action="descargar.php">
			...
			<tr>
				<td>
					<button type="button" class="btn btn-success" style= "float: left;position: relative;left: 50%;" onclick="send_data()">
									 <i class="icon-plane icon-white"></i> Validar
					</button>
				</td>
				<td width="50%"></td>
			</tr>
...
<script>
    ...
    $( '.activePlantilla1' ).html( "<a href='index.php'><?=$NOMBRE_SHOW_PLURAL?></a> > <a href='link_sap.php'>Link SAP</a>");
</script>

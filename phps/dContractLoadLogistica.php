...
$data                       = getAllContratosToApproveVistaLogistica($ROLE_RESPONSABLE_LOGISTICA, $sql_table_elements);
$recordsFiltered            = getAllContratosToApproveVistaLogistica_count($sql_table_elements)[0]['cantidad'];

...
$ROLE_USUARIO 	= 1;
$data                       = getAllMiContratos($_GET['sp_filter_userid'], $ROLE_USUARIO, $sql_table_elements);
$recordsFiltered            = getAllMiContratos_count($_GET['sp_filter_userid'], $ROLE_USUARIO, $sql_table_elements)[0]['cantidad'];

            ...
            <div id="table_report_wrapper" class="dataTables_wrapper" role="grid">
                <table id="table_report" class="table table-striped table-bordered table-hover dataTable"
                    ...
                    <tr role="row">
						...
						<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1"
                            colspan="1"
                            style="width: 143px;">Ubicacion
                        </th>	
						<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1"
                            colspan="1"
                            style="width: 143px;">Dirección
                        </th>							
						<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1"
                            colspan="1"
                            style="width: 143px;">Nro Estacion
                        </th>
						<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1"
                            colspan="1"
                    ...
                    $data = getAllValesGrifos();

                    if(!empty($data) && $data != false){

                        foreach($data as $d){
							
							$ubicacion = ( !empty($d['longitud']) && !empty($d['latitud']) )?($d['latitud'].",".$d['longitud']):"-";
							
                            echo "<tr class=\"odd\">";
                            echo "<td>".$d['id']."</td>";
                            echo "<td class=\"id\">".$d['id']."</td>";
                            echo "<td class=\"nombre\">".$d['nombre']."</td>";
							echo "<td class=\"desc\"><small>".$d['descripcion']."</small></td>";							
							echo "<td class=\"ubicacion\"><small>".$ubicacion."</small></td>";
							echo "<td class=\"direccion\"><small>".$d['direccion']."</small></td>";
							echo "<td class=\"nroestacion\"><small>".$d['nroestacion']."</small></td>";
							echo "<td class=\"flujo\"><small>".$d['flujo']."</small></td>";
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="validation-form_editar" method="get" novalidate="novalidate">
						...
						<div class="control-group">
                            <label class="control-label" for="desc_editar">Descripcion :</label>

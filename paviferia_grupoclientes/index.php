...
$NOMBRE_SHOW = "Grupo Cliente";
$NOMBRE_SHOW_PLURAL = "Grupos Clientes";
        ...
        <div class="row-fluid">
            ...
            <div id="table_report_wrapper" class="dataTables_wrapper" role="grid">
                <table id="table_report" class="table table-striped table-bordered table-hover dataTable"
                    ...
                    $data = getAllGruposPaviferiaCliente();
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="validation-form_editar" method="get" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="descuento_editar">Descuento(%) : </label>

                            <div class="controls">
                                <div class="span12">
                                    <input type="text" name="descuento_editar" id="descuento_editar" class="span6 uppercase" autocomplete="off">
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#validation-form_editar').validate({
            ...
            submitHandler: function (form) {
                ...
                var descuento =   $("#descuento_editar").val();
    ...
    $("a","#table_report").on("click",function  () {
        ...
        var descuento = $(this).parent().parent().parent().children("td.descuento").text();

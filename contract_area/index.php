    ...
    <div class="row-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="table-header">
                Resultados de "<?=$NOMBRE_SHOW_PLURAL?> registradas"
            </div>
                ...
                <table id="table_report" class="table table-striped table-bordered table-hover dataTable"
                    ...
                    <tr role="row">
                        ...
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1"
                            colspan="1"
                            style="width: 143px;">Area
                        </th>
						<th class="sorting" role="columnheader" tabindex="0" aria-controls="table_report" rowspan="1"
                            colspan="1"
                            style="width: 143px;">Codigo
                        </th>
                    ...
                    if(!empty($data) && $data != false){
                        ...
                        foreach($data as $d){
							...
							echo "<td class=\"codigo\">".$d['codigo']."</td>";
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="validation-form_nuevo" method="get" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="desc_nuevo">Area :</label>
						...
						<div class="control-group">
                            <label class="control-label" for="codigo_nuevo">Codigo :</label>

                            <div class="controls">
                                <div class="span12">
                                    <input type="text" name="codigo_nuevo" id="codigo_nuevo" class="span6 uppercase" autocomplete="off">
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" id="validation-form_editar" method="get" novalidate="novalidate">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="desc_editar">Area :</label>
						...
						<div class="control-group">
                            <label class="control-label" for="codigo_editar">Codigo :</label>

                            <div class="controls">
                                <div class="span12">
                                    <input type="text" name="codigo_editar" id="codigo_editar" class="span6 uppercase" autocomplete="off">
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $("a","#table_report").on("click",function  () {
		...
		var codigo = $(this).parent().parent().parent().children("td.codigo").text();
